...
#define LABEL_MRK '"'
/* modernize: make COMMENT_MRK a character literal */
#define COMMENT_MRK '#'
 ...
 */
static valid_terms boundary_terms[] = {{"NONE", NONE},
                                       {"STANDARD", STANDARD},
                                       {"MISORIENTATION", MISORIENTATION},
                                       {"RAINBOW", RAINBOW},
                                       {nullptr, 0}};
static valid_terms node_terms[] = {{"NONE", NONE},
                                   {"NEIGHBOURS", NUM_NB},
                                   {"TRIPLES", TRPL_ONLY},
                                   {"VELOCITY_X", VEL_X},
                                   {"VELOCITY_Y", VEL_Y},
...
static valid_terms unode_terms[] = {{"NONE", NONE},
                                    {"LOCATION", U_LOCATION},
                                    {"CONC_A", CONC_A},
                                    {"CAXIS_X", CAXIS_X},
                                    {"CAXIS_Y", CAXIS_Y},
...
static valid_terms segment_terms[] = {{"LOCATION", S_LOCATION},
                                      {"S_PERMEABILITY", S_PERMEABILITY},
                                      {"S_FLUID_FLUX", S_FLUID_FLUX},
                                      {nullptr, 0}};

static valid_terms region_terms[] = {{"NONE", NONE},
                                     {"CAXIS_X", CAXIS_X},
                                     {"CAXIS_Y", CAXIS_Y},
                                     {"CAXIS_Z", CAXIS_Z},
                                     {"CAXIS", CAXIS},
...
static valid_terms option_terms[] = {{"Update_Interval", O_UPDFREQ},
...
static valid_terms display_terms[] = {{"orientation", O_ORIENT},
...
static valid_terms paper_terms[] = {
    {"A4", A4_PAPER}, {"USLetter", US_PAPER}, {nullptr, 0}};
static valid_terms colmap_terms[] = {{"greyscale", GREY_MAP},
                                     {"grayscale", GREY_MAP},
                                     {"standard", STD_MAP},
                                     {"absolute", ABS_MAP},
                                     {nullptr, 0}};
static valid_terms linestyle_terms[] = {
    {"solid", SOLID}, {"dash", DASH}, {"dot", DOT}, {nullptr, 0}};
/*

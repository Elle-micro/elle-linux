...
private:
  bool ucmdargs, rangeflagunodes, notrangeflagunodes, showflynnnumbers,
      shownodenumbers, savepics, rainbow, fclampcolor, bclampcolor, nclampcolor,
      uclampcolor;
  bool rangeflagsegments, notrangeflagsegments, sclampcolor;
  double unodesrangeflagmaxvalue, unodesrangeflagminvalue,
      unodesnotrangeflagmaxvalue, unodesnotrangeflagminvalue;
  double segmentsrangeflagmaxvalue, segmentsrangeflagminvalue,
      segmentsnotrangeflagmaxvalue, segmentsnotrangeflagminvalue;
  int nodesize, unodesize, segmentsize, linesize, tnodecolor[3], dnodecolor[3],
      linecolor[3], loglevel, cstages, raincolor, rainchange;
  int cmap[264][4];

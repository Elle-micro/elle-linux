...
enum {
  ...
  ID_Pbnodeshow,
  ID_Pbitmapsize,
  ID_Pflynnshownumbers,
  ID_Pcolorsingleflynn,
  ID_Pnodeshownumbers,
  ID_Unodes3d,
  ID_PResetSingleFlynnColor,
  ID_Prangeflagunodes,
  ID_punoderangeflagmaxval,
  ID_punoderangeflagminval,
  ID_Pnotrangeflagunodes,
  ID_punodenotrangeflagmaxval,
  ID_punodenotrangeflagminval,
  ID_PSave,
  ID_Prangeflagsegments,
  ID_psegmentrangeflagmaxval,
  ID_psegmentrangeflagminval,
  ID_Pnotrangeflagsegments,
  ID_psegmentnotrangeflagmaxval,
  ID_psegmentnotrangeflagminval,
  ID_PLoad,
  ID_Punodetriangles,
  ID_FClampColor,
  ID_FCCMin,
...
public:
  CBarPane(wxWindow *parent, const wxSize = wxDefaultSize);
...
public:
  LinePane(wxWindow *parent, const wxSize = wxDefaultSize, int wdth = 1,
           wxColor col = *wxWHITE);
...
public:
  DotPane(wxWindow *parent, const wxSize = wxDefaultSize, int size = 1,
          wxColor col = *wxBLUE);
...
private:
  ...
  wxTextCtrl *uvalmin, *uvalmax, *Fccmin, *Fccmax, *Bccmin, *Bccmax, *Nccmin,
      *Nccmax, *Uccmin, *Uccmax;

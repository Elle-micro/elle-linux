...
static valid_terms option_terms[] = {
    {"Update_Interval", O_UPDFREQ},         {"Overlay_Plot", O_OVERLAY},
    {"Unode_triangulation", O_DRWUNODETYP}, {"Flynn_Labels", O_LBLREGION},
    {"Flynn_Attribute", O_FLYNNATTRIB},     {"Node_Attribute", O_NODEATTRIB},
    {"Unode_Attribute", O_UNODEATTRIB},     {"Boundary_Attribute", O_BNDATTRIB},
    {"Boundary_Level", O_BNDLEVEL},         NULL};

...
public:
  ...
  void GetRegionOption(int *val) { GetCRegionOption(val); }
  void GetUpdFreqOption(int *val) { GetCUpdFreqOption(val); }
  void GetUnodePlotOption(int *val) { GetCUnodePlotOption(val); }
  void GetNodeAttribOption(int *val) { GetCNodeAttribOption(val); }
  void SetNodeAttribOption(int id, double min, double max) {
    SetCNodeAttribOption(id, min, max);
  }
  void GetNodeAttribMinOption(double *val) { GetCNodeAttribMinOption(val); }
  void GetNodeAttribMaxOption(double *val) { GetCNodeAttribMaxOption(val); }
  void GetFlynnAttribOption(int *val) { GetCFlynnAttribOption(val); }
  void SetFlynnAttribOption(int id, double min, double max) {
    SetCFlynnAttribOption(id, min, max);
  }
  void GetFlynnAttribMinOption(double *val) { GetCFlynnAttribMinOption(val); }
  void GetFlynnAttribMaxOption(double *val) { GetCFlynnAttribMaxOption(val); }
  void GetUnodeAttribOption(int *val) { GetCUnodeAttribOption(val); }
  void GetUnodeAttribMinOption(double *val) { GetCUnodeAttribMinOption(val); }
  void GetUnodeAttribMaxOption(double *val) { GetCUnodeAttribMaxOption(val); }
  void GetSegmentAttribOption(int *val) { GetCSegmentAttribOption(val); }
  ...
  void GetBndAttribOption(int *val) { GetCBndAttribOption(val); }
  void GetBndLevelOption(int *val) { GetCBndLevelOption(val); }
  void SetBndLevelOption(int val) { SetCBndLevelOption(val); }
  void GetLblRgnOption(int *val) { GetCLblRgnOption(val); }
  void GetDrawingOption(int *val) { GetCDrawingOption(val); }
  int GetPlotColourRange(int *min, int *max) { GetCPlotColourRange(min, max); }
  void SetRainbow(bool s) { rainbow = s; }
  bool GetRainbow() { return rainbow; }
  void GetOverlayOption(int *val) { GetCOverlayOption(val); }
  void GetBndAttribMinOption(double *val) { GetCBndAttribMinOption(val); }
  void GetBndAttribMaxOption(double *val) { GetCBndAttribMaxOption(val); }
  ...
  void GetForegroundOption(int *val) { GetCForegroundOption(val); }
};

int FillPolygon(int, float *, float *, int *, int *, int *);
int DrawNode(int, float *, float *, float *, int *, int *);
int DrawUnodes(int col_range, int col_min, int attr, double min, double max);
int DrawSegments(int col_range, int col_min, int attr, double min, double max);

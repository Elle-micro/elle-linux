 ...
 * incr=16
 */
static int Rgb0[STEPS * 3] = {128, 128, 128, 144, 144, 144, 160, 160, 160,
                              176, 176, 176, 192, 192, 192, 208, 208, 208,
                              224, 224, 224, 240, 240, 240, 255, 255, 255};
/*
 * greyscale
 * incr=24
 ...
 *  standard colourmap
 */
static int Rgb1[STEPS * 3] = {0,   0,   255, 128, 128, 255, 128, 255, 255,
                              0,   255, 0,   255, 255, 128, 255, 255, 0,
                              255, 128, 128, 255, 0,   0,   255, 128, 255};

...
int DoSomethingToFlynn(int flynn) {
  ...
  ElleGetFlynnRealAttribute(flynn, &dislocden,
                            DISLOCDEN); // get attribute for this flynn
  ElleSetFlynnRealAttribute(flynn, dislocden * 0.99,
                            DISLOCDEN); // set attribute for this flynn
}

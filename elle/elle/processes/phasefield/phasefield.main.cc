...
main(int argc, char** argv) {
  ...
  ElleSetOptNames("Reset Unode Values", "Latent heat", "Interfacial width", "Width modulation", "Orientation",
                  "Anisotropy", "Alpha", "Gamma", "unused");
...
void Reference() {
  ...
  printf("a = flag to reset elle file unodes to 300x300 square grid (default = "
         "0, reset = 1) \n");

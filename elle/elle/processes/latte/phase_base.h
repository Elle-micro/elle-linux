...
public:
  ...
  void Set_Time(float intime,
                int intimescale); // set absolute time and timescale
  void Set_Mass_Distribution(float mass_size,
                             float factor); // set a distribution on mass
};

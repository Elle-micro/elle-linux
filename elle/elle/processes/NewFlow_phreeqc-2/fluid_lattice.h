...
// change the resolution of teh elle file her:
#define dimX 50 // num particles along x
#define dimY 50 // num particles along y
#define dimM 50 // multiplicator?
...
public:
  ...
  void test_pressure_with_source();

 ...
 * if the magic number (fudge factor) is negative, it will not be altered during
 * the simulations, otherwise it will be adjusted to keep the melt fraction
 * stable.
 *
...
main(int argc, char** argv) {
  ...
  sprintf(buf,
          "mob\t\tmagic\t\tpercent\t\txl-xl\t\tliq-xl\t\tliq-"

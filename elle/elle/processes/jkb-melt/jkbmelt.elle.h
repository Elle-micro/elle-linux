...
int Melt_MoveNode4Pos(int flynn, int n, Coords *movedir, int *same,
                      double arealiq, double mobfac, double fudge,
                      double areaequil, double energyxlxl, double energyliqxl,
                      double energyliqliq);
int Melt_MoveNode3Pos(int flynn, int n, Coords *movedir, int *same,
                      double arealiq, double mobfac, double fudge,
                      double areaequil, double energyxlxl, double energyliqxl,
                      double energyliqliq);
double GetSurfaceNodeEnergy(int n, int meltmineral, Coords *xy, double *energy,

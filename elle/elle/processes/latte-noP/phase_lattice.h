...
public:
  ...
  void Adjust_Conc_Box(int change, int diffusion, double timedif);

  void SolveDiffusionExplicit(double time, double space, double difconstant);
  ...
  void GrowthDissolution(int dump, int use_Box, int change,
                         int experiment_time);
  void GrowthDissolutionTwo(int dump, int use_Box, int change,
                            int experiment_time);

  void Fill_Fluid(float ymax, float concentration);
};

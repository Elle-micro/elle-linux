 ...
 * This software is given to you under the GPL. If you do not know what that is,
 *please go to the <a href="http://www.gnu.org/copyleft/gpl.html"> GPL-Site</A>
 ...
 *
 * The class mainapp is just the entry point for wxWidgets. The class
 * mainwinFrame is the main class making all the windows and other needed tings.
 * */
#ifndef _MAIN_H_
#define _MAIN_H_
...
public:
  mainwinFrame(const wxString &title, const wxPoint &pos, const wxSize &po1s,
               const wxString &arg0);
  void Init();

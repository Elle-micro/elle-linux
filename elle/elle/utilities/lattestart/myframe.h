...
enum ext_proc { LATTE_PROC, ELLE_TO_PS_PROC, PS_TO_GIF_PROC, CONVERT_MOVIE };
...
private:
  ...
  wxString elle_filename, start_file_dir, end_file_dir, save_file_dir,
      gif_save_file, moviemake_dir;

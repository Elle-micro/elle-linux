...
{
    wxFileDialog dialog( this, wxT( "Choose elle-file" ), appdirectory, wxEmptyString, _T( "elle-files (*.elle)|*.elle" ), wxFD_OPEN );
...
{
    wxFileDialog dialog( this, wxT( "Choose zip-archive" ), archive_dir, wxEmptyString, _T( "ZIP archives (*.zip)|*.zip" ), wxFD_OPEN );
    int cont;
...
void MyFrame::BrowseZip( wxCommandEvent& WXUNUSED( event ) )
{
    ...
    wxFileDialog dialog( this, _T( "Choose a ZIP archive" ), wxGetCwd(), wxEmptyString, _T( "ZIP archives (*.zip)|*.zip" ), wxFD_OPEN );
...
{
    wxFileDialog dialog( this, wxT( "Choose elle-file" ), elle_dir, wxEmptyString, _T( "elle-files (*.elle)|*.elle" ), wxFD_SAVE );
...
void MyFrame::MakeMovie( wxCommandEvent& WXUNUSED( event ) )
{
    ...
    // Ã¼berprÃ¼fen, ob alle files verfÃ¼gbar sind, evt stepsize anpassen, evt erneut Ã¼berprÃ¼fen
...
{
    wxFileDialog dialog( this, wxT( "Choose elle-file" ), moviemake_dir, wxEmptyString, _T( "elle-files (*.elle)|*.elle" ), wxFD_OPEN );
...
{
    wxFileDialog dialog( this, wxT( "Choose filename" ), moviemake_dir, wxEmptyString, _T( "gif-files (*.gif)|*.gif" ), wxFD_SAVE );
...
{
    wxFileDialog dialog( this, wxT( "Choose movie-file" ), elle_dir, wxEmptyString, _T( "movie-files (*.gif;*.avi; *.mpg)|*.gif;*.avi;*.mpg" ), wxFD_OPEN );

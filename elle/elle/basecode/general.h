...
#include <cstdio>
// modernize: add common portability macros (A26) (analysis fast-track)
...
int polyCentroid(float x[], float y[], int n, double *xCentroid,
                 double *yCentroid, double *area);
int lines_intersect(double x1, double y1, double x2, double y2, double x3,
                    double y3, double x4, double y4, double *x, double *y);
int intersection_pt(double x1, double y1, double x2, double y2, double x3,
                    double y3, double x4, double y4, double *x, double *y);

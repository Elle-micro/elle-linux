...
// Ensure ELL_MAYBE_UNUSED is available for annotating large header tables
// via the centralized portability header (works for both C and C++ TUs).
...
ELL_MAYBE_UNUSED static valid_terms run_option_terms[] = {
    {"Stages", RO_STAGES},
    {"Display", RO_DISPLAY},
    {"Verbose", RO_VERBOSE},
...
void ElleIncrementCount(void); // explicit void
...
ElleRunFunc ElleInitFunction(void); // explicit void
ElleRunFunc ElleRunFunction(void);  // explicit void
ElleRunFunc ElleExitFunction(void); // explicit void
int ElleCount(void);                // explicit void
...
double ElleTime(void);        // explicit void
double ElleTimestep(void);    // explicit void
double ElleUnitLength(void);  // explicit void
double ElleTemperature(void); // explicit void
double EllePressure(void);    // explicit void
double ElleBndWidth(void);    // explicit void
double ElleMassIncr(void);    // explicit void
void ElleUserData(UserData value);
double ElleSSOffset(void);     // explicit void
double ElleCumSSOffset(void);  // explicit void
double EllePSOffset(void);     // explicit void
double ElleMinFlynnArea(void); // explicit void
double ElleMaxFlynnArea(void); // explicit void
extern int ElleDisplay(void);  // explicit void
int ElleRescale(void);         // explicit void
void ElleInitRunOptions(void); // explicit void
int StartApp(void);            // explicit void
int ElleDisplayHelpMsg(void);  // explicit void

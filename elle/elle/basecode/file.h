...
// Behavior-neutral: hint compilers to suppress unused warnings for some
// header-level lookup tables that are intentionally included widely. Keeps
// warnings noise low across TUs.
// Use the project-wide portability macros so C TUs don't trigger pedantic
// warnings for C++ attributes.
#include <elle/common/portability.h>
#if !defined(ELL_MAYBE_UNUSED)
#define ELL_MAYBE_UNUSED ELLE_MAYBE_UNUSED
#endif
 ...
 */
ELL_MAYBE_UNUSED static valid_terms FileKeys[] = {
    {"OPTIONS", E_OPTIONS},
    {"REGIONS", REGIONS},
    {"FLYNNS", FLYNNS},
    {"PARENTS", PARENTS},
...
ELL_MAYBE_UNUSED static valid_terms MineralKeys[] = {
    {"QUARTZ", QUARTZ},       {"FELDSPAR", FELDSPAR},
    {"MICA", MICA},           {"GARNET", GARNET},
    {"CALCITE", CALCITE},     {"ICE", ICE},
    {"OLIVINE", OLIVINE},     {"MAGNESIUM", MAGNESIUM},
    {"OMPHACITE", OMPHACITE}, {"CLINOPYROXENE", CLINOPYROXENE},
    {"MINERAL_A", MINERAL_A}, {"MINERAL_B", MINERAL_B},
    {"MINERAL_C", MINERAL_C}, {NULL, 0} // sentinel
};

ELL_MAYBE_UNUSED static valid_terms VelocityKeys[] = {
    {"VEL_X", VEL_X}, {"VEL_Y", VEL_Y}, {NULL, 0} // sentinel
};

ELL_MAYBE_UNUSED static valid_terms StressKeys[] = {
    {"TAU_XX", TAU_XX}, {"TAU_YY", TAU_YY}, {"TAU_ZZ", TAU_ZZ},
    {"TAU_XY", TAU_XY}, {"TAU_1", TAU_1},   {"PRESSURE", PRESSURE},
    {NULL, 0} // sentinel
};

ELL_MAYBE_UNUSED static valid_terms StrainKeys[] = {
    {"INCR_S", INCR_S}, {"BULK_S", BULK_S}, {NULL, 0} // sentinel
};

ELL_MAYBE_UNUSED static valid_terms FiniteStrainKeys[] = {
    {"START_S_X", START_S_X},
    {"START_S_Y", START_S_Y},
    {"PREV_S_X", PREV_S_X},
    {"PREV_S_Y", PREV_S_Y},
 ...
 */
ELL_MAYBE_UNUSED static valid_terms FlynnStrainKeys[] = {
    {"INCR_S", INCR_S}, {"BULK_S", BULK_S},   {"E_XX", E_XX},
    {"E_XY", E_XY},     {"E_YX", E_YX},       {"E_YY", E_YY},
    {"E_ZZ", E_ZZ},     {"INCR_S", F_INCR_S}, {"BULK_S", F_BULK_S},
    {NULL, 0} // sentinel
};

ELL_MAYBE_UNUSED static valid_terms FlynnAgeKeys[] = {
    {"AGE", AGE}, {"CYCLE", CYCLE}, {NULL, 0} // sentinel
};

ELL_MAYBE_UNUSED static valid_terms Leftovers[] = {
    {"NONE", NONE},         {"TRIPLE", TRPL_ONLY},
    {"NEIGHBOURS", NUM_NB}, {"RAINBOW", RAINBOW},
    {"E3_ALPHA", E3_ALPHA}, {"E3_BETA", E3_BETA},
    {"E3_GAMMA", E3_GAMMA}, {NULL, 0} // sentinel
};

ELL_MAYBE_UNUSED static valid_terms BoundaryKeys[] = {
